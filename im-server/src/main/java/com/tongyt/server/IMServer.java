...
public class IMServer {
    ...
    public void start() {
        ...
        log.info("IM server started on port: {} (TCP) with boss thread {}", this.port, this.bossThread);
    }
    ...
    public void init() {
        ...
        this.serverBootstrap.childHandler(channelHandlerInitializer);
    }
